function [pclass] = class_expert_v201007(profiles_matrix,params,visual_en)
...
[class_with_peaks,class_no_peaks]  = cmodAnypeak_v3(prof_mtx_aux,visual_sub_en,shft_l,shft_r,wfilter,ksec,t_start,t_basal_0,t_basal_n);
pclass(p_idx(class_no_peaks)) = 1;
